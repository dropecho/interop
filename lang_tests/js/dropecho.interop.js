...
$hxClasses["Type"] = Type;
Type.__name__ = "Type";
class dropecho_utils__$AbstractMap_AbstractMap_$Impl_$ {
	static _new(s) {
		var this1 = s;
		return this1;
	}
	...
	static isJsMap(value) {
		return ((value) instanceof Map);
	}
}
$hxClasses["dropecho.utils._AbstractMap.AbstractMap_Impl_"] = dropecho_utils__$AbstractMap_AbstractMap_$Impl_$;
dropecho_utils__$AbstractMap_AbstractMap_$Impl_$.__name__ = "dropecho.utils._AbstractMap.AbstractMap_Impl_";
class dropecho_utils_Extender {
	...
	static defaults(base,extension) {
		...
		while(_g < extensions.length) {
			...
			while(_g1 < _g11.length) {
				...
				if(dropecho_utils_Extender.isArray(baseField)) {
					var arr = js_Boot.__cast(exField , Array);
					var _g2 = 0;
				...
				} else if(dropecho_utils_Extender.isMap(baseField)) {
					var copy = dropecho_utils__$AbstractMap_AbstractMap_$Impl_$.fromAny(exField);
					var _g3 = new haxe_iterators_MapKeyValueIterator(copy);
					while(_g3.hasNext()) {
						var _g12 = _g3.next();
						var k = _g12.key;
						var v1 = _g12.value;
	...
	static isMap(obj) {
		...
		haxe_Log.trace("type",{ fileName : "src/dropecho/utils/Extender.hx", lineNumber : 73, className : "dropecho.utils.Extender", methodName : "isMap", customParams : [type]});
...
$hxClasses["dropecho.utils.Extender"] = $hx_exports["Extender"] = dropecho_utils_Extender;
dropecho_utils_Extender.__name__ = "dropecho.utils.Extender";
class dropecho_utils_TestClassConfig {
}
$hxClasses["dropecho.utils.TestClassConfig"] = dropecho_utils_TestClassConfig;
dropecho_utils_TestClassConfig.__name__ = "dropecho.utils.TestClassConfig";
Object.assign(dropecho_utils_TestClassConfig.prototype, {
	__class__: dropecho_utils_TestClassConfig
	,int: null
	,float: null
});
class dropecho_utils_TestThisClass {
	constructor(opts) {
		this.subarr = [];
		this.arr = [];
		this.map = new haxe_ds_StringMap();
		dropecho_utils_Extender.defaults(this,opts);
	}
	test() {
		return this.subarr[0].int + this.int;
	}
}
$hxClasses["dropecho.utils.TestThisClass"] = $hx_exports["TestThisClass"] = dropecho_utils_TestThisClass;
dropecho_utils_TestThisClass.__name__ = "dropecho.utils.TestThisClass";
Object.assign(dropecho_utils_TestThisClass.prototype, {
	__class__: dropecho_utils_TestThisClass
	,int: null
	,float: null
	,map: null
	,arr: null
...
class dropecho_utils_TestMap {
	static setMap(value) {
		dropecho_utils_TestMap.map = dropecho_utils__$AbstractMap_AbstractMap_$Impl_$.fromAny(value);
	}
}
dropecho_utils_TestMap.map = null;
$hxClasses["dropecho.utils.TestMap"] = $hx_exports["TestMap"] = dropecho_utils_TestMap;
dropecho_utils_TestMap.__name__ = "dropecho.utils.TestMap";
class haxe_IMap {
}
...
class js_lib__$Map_MapEntry_$Impl_$ {
...
$hxClasses["js.lib._Map.MapEntry_Impl_"] = js_lib__$Map_MapEntry_$Impl_$;
js_lib__$Map_MapEntry_$Impl_$.__name__ = "js.lib._Map.MapEntry_Impl_";
js_lib__$Map_MapEntry_$Impl_$.__properties__ = {get_value: "get_value",get_key: "get_key"};
