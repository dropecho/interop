...
class dropecho_interop_test_TestFunc {
	constructor() {
		this.Action0 = function() {
			haxe_Log.trace("wee",{ fileName : "src/dropecho/interop/test/TestFunc.hx", lineNumber : 17, className : "dropecho.interop.test.TestFunc", methodName : "new"});
		};
		this.Action1 = function(x) {
			haxe_Log.trace("wee: " + Std.string(x),{ fileName : "src/dropecho/interop/test/TestFunc.hx", lineNumber : 18, className : "dropecho.interop.test.TestFunc", methodName : "new"});
		};
		this.Action2 = function(x,y) {
			haxe_Log.trace("wee: " + Std.string(x) + "," + Std.string(y),{ fileName : "src/dropecho/interop/test/TestFunc.hx", lineNumber : 19, className : "dropecho.interop.test.TestFunc", methodName : "new"});
		};
		this.Func0 = function() {
			return 32;
		};
